<?php
/*
Template Name: Historical Results
*/
?>

<?php get_header(); ?>
	<?php if (have_posts()) while (have_posts()) : the_post(); ?>
    <?php $titeln = get_the_title();?>
    <div id="historik" class="main"<?php if($titeln == "Maratontabeller"){echo "style='width:100%'";}?>>
...
<?php if($titeln != "Maratontabeller"){get_sidebar();} ?>
<?php get_footer(); ?>